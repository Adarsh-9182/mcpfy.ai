...
const field =
  "h-10 w-full rounded-lg border bg-background/60 px-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-foreground/30";
...
export function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border bg-card/40 p-10 text-center">
        <span className="grid size-11 place-items-center rounded-full border bg-background">
          <Check className="size-5" />
        </span>
        <p className="mt-4 text-base font-medium">Thanks — message received</p>
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex flex-col gap-4 rounded-xl border bg-card/40 p-6 sm:p-7"
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          required
          rows={5}
          className="w-full resize-y rounded-lg border bg-background/60 p-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-foreground/30"
